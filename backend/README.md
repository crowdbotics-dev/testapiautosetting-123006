...
## Project Structure
    ...
    ├── testapiautosetting_123006  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123006`
...
2. Clone this repo and `cd testapiautosetting_123006`
